...
PHONE_METADATA_PH = PhoneMetadata(id='PH', country_code=63, international_prefix='00',
    ...
    mobile=PhoneNumberDesc(national_number_pattern='(?:81[37]|9(?:0[5-9]|1[024-9]|2[0-35-9]|3[02-9]|4[236-9]|5[06]|7[34-79]|89|9[4-9]))\\d{7}', possible_number_pattern='\\d{10}', example_number='9051234567', possible_length=(10,)),
